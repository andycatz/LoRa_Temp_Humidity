...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/PIC18F46K22_LoRa_TEMPHUM_V4.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=main.c usart2.c LoRa.c i2c1.c MAX31865.c ADS1110.c CRC16.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/main.p1 ${OBJECTDIR}/usart2.p1 ${OBJECTDIR}/LoRa.p1 ${OBJECTDIR}/i2c1.p1 ${OBJECTDIR}/MAX31865.p1 ${OBJECTDIR}/ADS1110.p1 ${OBJECTDIR}/CRC16.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/main.p1.d ${OBJECTDIR}/usart2.p1.d ${OBJECTDIR}/LoRa.p1.d ${OBJECTDIR}/i2c1.p1.d ${OBJECTDIR}/MAX31865.p1.d ${OBJECTDIR}/ADS1110.p1.d ${OBJECTDIR}/CRC16.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/main.p1 ${OBJECTDIR}/usart2.p1 ${OBJECTDIR}/LoRa.p1 ${OBJECTDIR}/i2c1.p1 ${OBJECTDIR}/MAX31865.p1 ${OBJECTDIR}/ADS1110.p1 ${OBJECTDIR}/CRC16.p1

# Source Files
SOURCEFILES=main.c usart2.c LoRa.c i2c1.c MAX31865.c ADS1110.c CRC16.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/PIC18F46K22_LoRa_TEMPHUM_V4.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/MAX31865.p1: MAX31865.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/MAX31865.p1.d 
	@${RM} ${OBJECTDIR}/MAX31865.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O2 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits -mc90lib $(COMPARISON_BUILD)  -std=c90 -gdwarf-3 -mstack=compiled:auto:auto:auto     -o ${OBJECTDIR}/MAX31865.p1 MAX31865.c 
	@-${MV} ${OBJECTDIR}/MAX31865.d ${OBJECTDIR}/MAX31865.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/MAX31865.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
	
${OBJECTDIR}/ADS1110.p1: ADS1110.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/ADS1110.p1.d 
	@${RM} ${OBJECTDIR}/ADS1110.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O2 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits -mc90lib $(COMPARISON_BUILD)  -std=c90 -gdwarf-3 -mstack=compiled:auto:auto:auto     -o ${OBJECTDIR}/ADS1110.p1 ADS1110.c 
	@-${MV} ${OBJECTDIR}/ADS1110.d ${OBJECTDIR}/ADS1110.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/ADS1110.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/PIC18F46K22_LoRa_TEMPHUM_V4.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=dist/${CND_CONF}/${IMAGE_TYPE}/PIC18F46K22_LoRa_TEMPHUM_V4.X.${IMAGE_TYPE}.map  -D__DEBUG=1  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O2 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits -mc90lib -std=c90 -gdwarf-3 -mstack=compiled:auto:auto:auto        $(COMPARISON_BUILD) -Wl,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -o dist/${CND_CONF}/${IMAGE_TYPE}/PIC18F46K22_LoRa_TEMPHUM_V4.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/PIC18F46K22_LoRa_TEMPHUM_V4.X.${IMAGE_TYPE}.hex 
