...
uint8_t txData[50];
uint8_t address[8] = {0x6C,0x27,0xDA,0x88,0x2F,0xE4,0x1A,0xF0};
uint16_t batt=0;
uint16_t temp=0;
uint16_t vsupply=0;
uint16_t vfan=0;
...
txData[20] = (uint8_t)((vsupply>>8)&0xFF);
txData[21] = (uint8_t)((vsupply & 0xFF));

txData[22] = (uint8_t)((vfan>>8)&0xFF);
txData[23] = (uint8_t)((vfan & 0xFF));


txData[24]=(uint8_t)((extTemp>>8)&0xFF);
txData[25]=(uint8_t)((extTemp)&0xFF);


txData[26]=(uint8_t)((rh>>8)&0xFF);
txData[27]=(uint8_t)((rh & 0xFF));


txData[28] = (uint8_t)((fanTachoCount>>24)&0xFF);
txData[29] = (uint8_t)((fanTachoCount>>16)&0xFF);
txData[30] = (uint8_t)((fanTachoCount>>8)&0xFF);
txData[31] = (uint8_t)((fanTachoCount & 0xFF));
...
uint16_t readRH(){
uint16_t rhTemp = readADS1110(0b10010000);
return rhTemp;
}
